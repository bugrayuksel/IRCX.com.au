...
"use strict";
    ...
    function activeMenuItem(item) {
        if ( !item ) {
            return location.hush = defaultStartPage;
        }
    ...
    function ajaxLoader() {
        ...
        $(document)
            .on("click",".site-main-menu, #ajax-page-close-button, .ajax-page-overlay", function (e) { // Hide Ajax Loaded Page on Navigation cleck and Close button
                e.preventDefault();
                hideContent();
